...
export class RuleElement {
  ...
  public static parse(sb: StreamBuffer) {
    ...
    switch (re.id) {
      ...
      case 0xf3: re.description = 'which is an alert email'; re.data = new SimpleRuleElementData(sb); break;
      case 0xf4: re.description = 'of the specific InfoPath form type'; re.data = new FormTypeRuleElementData(sb); break;
      ...
      case 0x143: re.description = 'do not search for commercial or adult content'; re.data = new SimpleRuleElementData(sb); break;
      case 0x144: re.description = 'redirect it to people'; re.data = new PeopleOrPublicGroupListRuleElementData(sb); break;
      case 0x145: re.description = 'add to relevance'; re.data = new SimpleRuleElementData(sb); break;
      ...
      case 0x218: re.description = 'except if it is of the specific InfoPath form type'; re.data = new FormTypeRuleElementData(sb); break;
      case 0x219: re.description = 'except if it is from RSS feeds with specified text in the title'; re.data = new StringsListRuleElementData(sb); break;
